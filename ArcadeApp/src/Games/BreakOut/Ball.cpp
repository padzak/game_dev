...
Ball::Ball(const Vec2D& pos, float radius):mBBox(pos - Vec2D(radius, radius), static_cast<uint32_t>(radius*2.0f), static_cast<uint32_t>(radius*2.0f)), mVelocity(Vec2D::Zero)
{
